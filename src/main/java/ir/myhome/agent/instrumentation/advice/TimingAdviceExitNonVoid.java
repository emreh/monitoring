// file: ir/myhome/agent/instrumentation/advice/TimingAdviceExitNonVoid.java
...
public final class TimingAdviceExitNonVoid {
    ...
    public static void exit(@Advice.Origin("#t.#m") String signature,
                            @Advice.Local("spanRef") Span[] spanRef,
                            @Advice.Return(readOnly = true, typing = net.bytebuddy.implementation.bytecode.assign.Assigner.Typing.DYNAMIC) Object returned,
        ...
        // record return shallow / safe
        try {
            String r = PrettyArgRenderer.render(returned);
            span.addTag("return", r);
        } catch (Throwable t) {
            span.addTag("return", "<unserializable>");
        }
