...
public final class AgentConfig {
    ...
    public int statusPort = 8082; // StatusServer
    public boolean enableAdvancedMetrics = true;
    public int percentileMaxValueMs = 60000;
    ...
    public String toString() {
        return "AgentConfig{" + "debug=" + debug + ", exporter=" + exporter + ", instrumentation=" + instrumentation + ", queueCapacity=" + queueCapacity + ", workerCount=" + workerCount + ", pollMillis=" + pollMillis + ", statusPort=" + statusPort + '}';
    }
}
